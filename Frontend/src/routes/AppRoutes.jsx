          ...
          <ProtectedRoute>
            <AppLayout>
              <Routes>
                ...
                {/* 2. Administrator Specific Paths */}
                ...
                <Route path="/nursee/appointments" element={<RoleRoute module="appointments"><AppointmentsPage /></RoleRoute>} />
                <Route path="/nursee/dashboard" element={<RoleRoute module="dashboard"><NurseDashboard /></RoleRoute>} />
